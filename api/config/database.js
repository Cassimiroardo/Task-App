...
module.exports = {
  ...
  */
  mongodb: {
    client: 'mongodb',
    connectionString: Env.get('DB_CONNECTION_STRING', 'mongodb+srv://dev:dev@adonisjs-anc3y.mongodb.net/AdonisJS?retryWrites=true&w=majority'),
    connection: {
      host: Env.get('DB_HOST', 'localhost'),
      port: Env.get('DB_PORT', 27017),
      username: Env.get('DB_USER', 'dev'),
      password: Env.get('DB_PASSWORD', 'dev'),
      database: Env.get('DB_DATABASE', 'AdonisJS'),
      options: {
